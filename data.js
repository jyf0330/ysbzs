...
const SHOP_PRICE_CONFIG = {
  ...
  shopSlots: {
    ...
    5: { unitT1:2, unitT2:2, unitT3:1, unitT4:1, consumable:0 },
    6: { unitT1:1, unitT2:2, unitT3:1, unitT4:1, consumable:0 },
...
const SHOP_POOLS = {
  ...
  day5_midday:['boom_sprite','split_sprite','fluff_speaker','spring_sprite','sprout_summoner','ember','fire_blaze','breeze_sprite'],
  day5_night:['boom_sprite','split_sprite','fluff_speaker','spring_sprite','ember_seed','forge_fire','command_sprout','fire_demon'],
  day6_midday:['fluff_speaker','spring_sprite','boom_sprite','split_sprite','forge_fire','command_sprout','fire_blaze','breeze_sprite','fire_demon'],
  day6_night:['fluff_speaker','spring_sprite','boom_sprite','split_sprite','forge_fire','command_sprout','breeze_sprite','fire_demon'],
