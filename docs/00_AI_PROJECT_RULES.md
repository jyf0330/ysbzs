...
6. `docs/03_美术资产（美术主导）/资源目录结构与命名.md`
7. `docs/04_测试验收（测试主导）/版本发布验收清单.md`
8. `docs/08_ROADMAP.md`
9. `docs/10_CHANGELOG.md`
10. `docs/02_程序开发（程序主导）/核心层与展示层分离设计.md`
11. `docs/02_程序开发（程序主导）/数据文件归档与分类规范.md`
12. `docs/04_测试验收（测试主导）/游戏闭环成熟度评分.md`
...
| UI / 美术 / 资源路径 | `docs/03_美术资产（美术主导）/美术风格指南.md` |
